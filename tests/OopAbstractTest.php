...
final class OopAbstractTest extends TestCase
{
    /**
    ...
    {
        include_once  __DIR__ . '/../src/assignments/oop-abstract/classes.php';
    }
    ...
    protected function setUp(): void
    {
        ...
        $this->assertTrue(class_exists(SetGet::class), 'Class `SetGet` is missing.');
        ...
        $attributes_parent_classes = $this->_reflector_attributes_object->getParentClass();
        $this->assertNotFalse($attributes_parent_classes, 'Class `Attributes` is not extending any class.');

        $attributes_parent_class_names = [];
        foreach ($attributes_parent_classes as $attributes_parent_class) {
            array_push($attributes_parent_class_names, $attributes_parent_class);
        }

        $this->assertContains('SetGet', $attributes_parent_class_names, 'Class `Attributes` is not extending class `SetGet`.');
        $this->assertTrue($this->_reflector_setget_object->isAbstract(), 'Class `SetGet` is not abstract.');
    }
