...
final class OopNamespaceTest extends TestCase
{
    /**
    ...
    {
        include_once __DIR__ . '/../src/assignments/oop-namespace/classes.php';
        include_once __DIR__ . '/../src/assignments/oop-namespace/interfaces.php';
        include_once __DIR__ . '/../src/assignments/oop-namespace/traits.php';
    }
    ...
    {
        $this->assertTrue(class_exists(Zoo\Animal::class), 'Class `Animal` is missing.');
        $this->assertTrue(class_exists(Zoo\Attributes::class), 'Class `Attributes` is missing.');
        $this->assertTrue(interface_exists(Zoo\SetGet::class), 'Interface `SetGet` is missing.');
        $this->assertTrue(trait_exists(Zoo\Kudos::class), 'Trait `Kudos` is missing.');

        $this->_animal_object = new Zoo\Animal('tiger', 'rawr');
        $this->_reflector_animal_object = new ReflectionClass(Zoo\Animal::class);
        $this->_reflector_attributes_object = new ReflectionClass(Zoo\Attributes::class);
        $this->_reflector_setget_object = new ReflectionClass(Zoo\SetGet::class);
        $this->_reflector_kudos_object = new ReflectionClass(Zoo\Kudos::class);
        ...
        $this->assertContains('Zoo\Attributes', $animal_parent_class_names, 'Class `Animal` is not extending class `Attributes`.');
        ...
        $this->assertContains('Zoo\Kudos', $animal_traits_names, 'Class `Animal` is not using trait `Kudos`.');
        ...
        $this->assertContains('Zoo\SetGet', $attributes_interfaces_names, 'Class `Attributes` is not using interface `SetGet`.');
    }
    ...
    {
        $this->assertTrue(property_exists(Zoo\Animal::class, 'species'), 'Class `Animal` is missing property `species`.');
        $this->assertTrue($this->_reflector_animal_object->getProperty('species')->isPublic(), 'Class `Animal` property `species` is not public.');

        $this->assertTrue(property_exists(Zoo\Animal::class, 'kudos'), 'Class `Animal` is missing property `kudos`.');
        $this->assertTrue($this->_reflector_animal_object->getProperty('kudos')->isPublic(), 'Class `Animal` property `kudos` is not public.');

        $this->assertTrue(property_exists(Zoo\Animal::class, 'calling'), 'Class `Animal` is missing property `calling`.');
        ...
        $this->assertTrue(property_exists(Zoo\Attributes::class, 'weight'), 'Class `Attributes` is missing property `weight`.');
        ...
        $this->assertTrue(property_exists(Zoo\Attributes::class, 'height'), 'Class `Attributes` is missing property `height`.');
        ...
        $this->assertTrue(property_exists(Zoo\Attributes::class, 'color'), 'Class `Attributes` is missing property `color`.');
        ...
        $this->assertTrue(property_exists(Zoo\Attributes::class, 'default'), 'Class `Attributes` is missing property `default`.');
        ...
        $this->assertTrue(property_exists(Zoo\Attributes::class, 'weight_unit'), 'Class `Attributes` is missing property `weight_unit`.');
    ...
    {
        $this->assertTrue(method_exists(Zoo\Animal::class, '__construct'), 'Class `Animal` is missing constructor.');
        $this->assertTrue(method_exists(Zoo\Animal::class, '__destruct'), 'Class `Animal` is missing destructor.');

        $this->assertTrue(method_exists(Zoo\Attributes::class, 'set_color'), 'Class `Attributes` is missing method `set_color`.');
        ...
        $this->assertTrue(method_exists(Zoo\Attributes::class, 'get_color'), 'Class `Attributes` is missing method `get_color`.');
        ...
        $this->assertTrue(method_exists(Zoo\SetGet::class, 'set_color'), 'Class `SetGet` is missing method `get_color`.');
        ...
        $this->assertTrue(method_exists(Zoo\SetGet::class, 'get_color'), 'Class `SetGet` is missing method `get_color`.');
        ...
        $this->assertTrue(method_exists(Zoo\Kudos::class, 'give_kudos'), 'Trait `Kudos` is missing method `give_kudos`.');
        $this->assertTrue($this->_reflector_kudos_object->getMethod('give_kudos')->isPublic(), 'Trait `Kudos` method `give_kudos` is not public.');

        $this->assertTrue(method_exists(Zoo\Kudos::class, 'count_kudos'), 'Trait `Kudos` is missing method `count_kudos`.');
        $this->assertTrue($this->_reflector_kudos_object->getMethod('count_kudos')->isPublic(), 'Trait `Kudos` method `count_kudos` is not public.');

        $this->assertTrue(method_exists(Zoo\Animal::class, 'get_weight_unit'), 'Class `Animall` is missing method `get_weight_unit`.');
     ...
     * @return Zoo\Animal
     */
    public function testGiveKudosMethod(): Zoo\Animal
    {
     ...
     * 
     * @param Zoo\Animal $instance 
     * 
     * @depends testGiveKudosMethod
     * 
     * @return void
     */
    public function testCountKudosMethod(Zoo\Animal $instance): void
    {
