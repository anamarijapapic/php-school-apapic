...
final class OopTraitTest extends TestCase
{
    /**
    ...
    {
        include_once __DIR__ . '/../src/assignments/oop-trait/classes.php';
        include_once __DIR__ . '/../src/assignments/oop-trait/interfaces.php';
        include_once __DIR__ . '/../src/assignments/oop-trait/traits.php';
    }
