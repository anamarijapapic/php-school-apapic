...
final class OopInterfaceTest extends TestCase
{
    /**
    ...
    {
        include_once __DIR__ . '/../src/assignments/oop-interface/classes.php';
        include_once __DIR__ . '/../src/assignments/oop-interface/interfaces.php';
    }
